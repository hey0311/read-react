...
export function scheduleUpdateOnFiber(
  ...
  console.log({ function: 'scheduleUpdateOnFiber',
    start: true,
    arguments
  });
  ...
  if (expirationTime === Sync) {
    if (
      ...
      console.log({ function: 'scheduleUpdateOnFiber',
        content: '同步Sync更新&&unbatchedUpdates&&not rendering'
      });
      ...
      console.log({ function: 'scheduleUpdateOnFiber',
        content: '同步Sync更新&&(!unbatchedUpdates||is rendering)',
        payload:{
          unbatchedUpdates:(executionContext & LegacyUnbatchedContext) !== NoContext ,
          isRendering:(executionContext & (RenderContext | CommitContext)) === NoContext
        }
      });
...
function ensureRootIsScheduled(root: FiberRoot) {
  console.log({ function:'ensureRootIsScheduled',
    start:true,
    arguments
  });
  const lastExpiredTime = root.lastExpiredTime;
...
function performSyncWorkOnRoot(root) {
  ...
  console.log({ function: 'performSyncWorkOnRoot',
    arguments,
    start: true
  });
...
function prepareFreshStack(root, expirationTime) {
  console.log({ function:'prepareFreshStack',
    start:true,
    arguments
  });
...
function renderRootSync(root, expirationTime) {
  console.log({ function: 'renderRootSync',
    arguments,
    start: true
  });
  const prevExecutionContext = executionContext;
...
function workLoopSync() {
  ...
  console.log({ function: 'workLoopSync',
    content: '循环执行performUnitOfWork',
    payload: {
      workInProgress
    }
  });
...
function performUnitOfWork(unitOfWork: Fiber): void {
  console.log({ function: 'performUnitOfWork',
    arguments,
    start: true
  });
...
function commitRoot(root) {
  console.log({ function:'commitRoot',
    start:true,
    arguments
  });
...
function commitRootImpl(root, renderPriorityLevel) {
  console.log({ function:'commitRootImpl',
    arguments,
  });
  if (__DEV__) {
    if (enableDebugTracing) {
...
function commitMutationEffects(root: FiberRoot, renderPriorityLevel) {
  ...
  console.log({ function:'commitMutationEffects',
    arguments,
  });
  while (nextEffect !== null) {
    setCurrentDebugFiberInDEV(nextEffect);
