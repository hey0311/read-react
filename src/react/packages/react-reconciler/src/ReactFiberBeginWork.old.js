...
export function reconcileChildren(
  ...
  console.log({ function:'reconcileChildren',
    arguments,
    content:'根据current判断是mount还是reconcile',
    payload:{
      current
    }
  });
  if (current === null) {
    ...
    // let's throw it out.
  console.log({ function:'reconcileChildren',
      content:'reconcileChildFibers返回fiber赋值给workInProgress.child'
  });
...
function updateHostRoot(current, workInProgress, renderExpirationTime) {
  console.log({ function:'updateHostRoot',
    start:true,
    arguments
  });
  ...
  console.log({ function:'updateHostRoot',
    ...
    payload:{
      return:workInProgress.child,
      note:'这里更新完会返回workInProgress.child,然后workInProgress指向其child'
    }
  });
  return workInProgress.child;
}
...
function beginWork(
  ...
  renderExpirationTime: ExpirationTime,
    ...
    console.log({ function:'beginWork',
      arguments
    });
  let a=1;
  loggggaw;
  ...
  console.log({ function:'beginWork',
    content:'判断workInProgress.tag进入相应的mount函数',
    payload:{
  ...
  console.log({ function:'beginWork',
    content:'tag为IndeterminateComponent',
    payload:{
      tag:workInProgress.tag,
    }
  });
