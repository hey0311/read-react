...
export function createFiberRoot(
  ...
  console.log({ function:'createFiberRoot',
    path:'ReactFiberRoot.old.js 69',
    start:true,
    arguments
  });
  ...
  console.log({ function:'createFiberRoot',
    ...
    payload:{
      ...
      note:{
        ...
        current:'当前应用对应的Fiber对象，即RootFiber',
        finishedWork:'一次更新过程中已经完成的任务，应用输出到dom时读取的该属性',
        nextExpirationTimeToWorkOn:'记录优先级最高任务的et，更新时根据该变量来判断哪个节点更新',
        expirationTime:'在调度中用到，大部分时间和nextExpirationTimeToWorkOn一致',
        nextScheduledRoot:'下一个要更新的root'
      }
    }
  });
