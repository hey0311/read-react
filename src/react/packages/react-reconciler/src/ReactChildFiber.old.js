...
function ChildReconciler(shouldTrackSideEffects) {
  ...
  function reconcileSingleElement(
    ...
    console.log({ function:'reconcileSingleElement',
      start:true,
      arguments
    });
  ...
  function reconcileChildFibers(
    ...
    console.log({ function:'reconcileChildFibers',
      arguments,
    });
    ...
    console.log({ function:'reconcileChildFibers',
      content:'isUnkeyedTopLevelFragment为true，newChild=newChild.props.children'
    });
    ...
    if (isObject) {
    console.log({ function:'reconcileChildFibers',
      content:'newChild是object',
      payload:{
        type:typeof newChild
      }
    });
      switch (newChild.$$typeof) {
        case REACT_ELEMENT_TYPE:
