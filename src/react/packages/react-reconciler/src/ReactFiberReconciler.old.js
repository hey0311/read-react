...
export function createContainer(
  ...
  console.log({ function:'createContainer',
    start:true,
    path:'ReactFiberReconciler.old.js 243',
    arguments,
    payload:{
      note:'创建root，是一个fiber对象'
    }
  });
  const container = createFiberRoot(containerInfo, tag, hydrate, hydrationCallbacks);
  console.log({ function:'createContainer',
    end:true,
    path:'ReactFiberReconciler.old.js 243',
    payload:{
...
export function updateContainer(
  ...
  console.log({ function:'updateContainer',
    start:true,
    path:'ReactFiberReconciler',
    arguments,
    payload:{
      note:'参数1是react实例(APP)，参数2是root节点'
    }
  });
  if (__DEV__) {
  ...
  console.log({ function:'updateContainer',
    content:'给update赋值payload和callback',
    payload:{
